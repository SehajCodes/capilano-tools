...
function drawAnglesMarkings() {
  ...
  if (anglesUnits == RADIANS) {
    ...
    noStroke()
    text("0", circleCenter*0.9, canvasSide-circleCenter*2.03)
    text("90°", circleCenter*0.67, (canvasSide-(circleCenter*2))*0.768)
    text("180°", circleCenter*0.63, (canvasSide-(circleCenter*2))*0.51)
    text("270°", circleCenter*0.59, (canvasSide-(circleCenter*2))*0.265)
    // text("360°", (canvasSide-(circleCenter*2))*0.23, circleCenter*0.14)
